...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String enter_password= "12345678";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Object data=FirebaseDatabase.getInstance();
    ...
    public void onClick(View v) {
        try{
            switch (v.getId()){
                case R.id.button_1:password[current_password_key] = 1;
                current_password_key++;
                break;

                case R.id.button_2:password[current_password_key]=2;
                current_password_key++;
                break;

                case R.id.button_3:password[current_password_key]=3;
                current_password_key++;
                break;

                case R.id.button_4:password[current_password_key]=4;
                current_password_key++;
                break;

                case R.id.button_5:password[current_password_key]=5;
                current_password_key++;
                break;

                case R.id.button_6:password[current_password_key]=6;
                current_password_key++;
                break;

                case R.id.button_7:password[current_password_key]=7;
                current_password_key++;
                break;

                case R.id.button_8:password[current_password_key]=8;
                current_password_key++;
                break;

                case R.id.button_9:password[current_password_key]=9;
                current_password_key++;
                break;

                case R.id.button_0:password[current_password_key]=0;
                current_password_key++;
                break;
        ...
        if (v.getId()== R.id.enter_button){
            ...
            if (password_entered.equals(enter_password)){
                Intent intent = new Intent(this, Flight_Management_Admin.class);
